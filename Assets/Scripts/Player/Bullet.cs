 ...
 */
    public class Bullet : MonoBehaviour
    {
        ...
        public void Fire(Vector3 pos1, Vector3 pos2, bool hit, Vector3 normal)
        {
            ...
            var timeTravel = (Vector3.Distance(pos1, pos2)) / (time*100f);
            ...
            fireSequence.Append(lineRenderer.material.DOColor(new Color(0, 0, 0, 0), "_Color", timeTravel));
            fireSequence.Join(DOVirtual.Float(0.0f, 1.0f, timeTravel, DoMoveVector));
            fireSequence.Join(DOVirtual.Float(0.0f, 2.0f, timeTravel, SetWhiteBalance));
            if (hit)
            {
